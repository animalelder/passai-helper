...
export default function Sidebar() {
  ...
  return (
    <div
      className={`flex min-h-dvh flex-col bg-darkblue-103 font-heading text-white duration-200 ease-in-out *:transition-discrete **:transition **:duration-200 **:ease-in-out ${isOpen ? "w-[250px]" : "w-[100px]"} relative`}
    >
