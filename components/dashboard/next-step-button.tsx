...
export default function NextStepButton() {
  return (
    <div className="group relative inline-flex items-center overflow-hidden rounded-md border-3 border-darkblue-102 px-4 py-2 transition duration-300 ease-in-out hover:text-white focus:outline-none active:scale-95">
      {/* Sliding background */}
