...
function SidebarGroupLabel({
  ...
  return (
    <Comp
      ...
      className={cn(
        "transition-margin transition-opacityduration-200 flex h-8 shrink-0 items-center rounded-md px-2 text-xs font-medium text-sidebar-foreground/70 ring-sidebar-ring outline-hidden ease-linear focus-visible:ring-2 [&>svg]:size-4 [&>svg]:shrink-0",
