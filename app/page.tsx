          ...
          <div className="relative pt-24 md:pt-36">
            ...
            <div className="mx-auto max-w-7xl px-6">
              <div className="text-center sm:mx-auto lg:mt-0 lg:mr-auto">
                ...
                >
                  Highly effective components for keeping score and notifications
                  that come and go the way you like it.
                </TextEffect>
                ...
                >
                  ...
                  >
                    ...
                    >
                      <Link href="#link">
                        <span className="text-nowrap">Get Organized</span>
                      </Link>
                    </Button>
                  </div>
                  <Button
        ...
        <section className="bg-background pt-16 pb-16 md:pb-32">
          <div className="group relative m-auto max-w-5xl px-6">
            <div className="absolute inset-0 z-10 flex scale-95 items-center justify-center opacity-0 duration-500 group-hover:scale-100 group-hover:opacity-100">
              ...
              >
                <span> Look at these impressive companies</span>
